...
RUN apt-get update;DEBIAN_FRONTEND=noninteractive apt-get install -yq git bash jq build-essential python-is-python3 python3-pip openssl libssl-dev pkg-config;apt-get clean
